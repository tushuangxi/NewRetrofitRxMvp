...
import com.xdw.retrofitrxmvpdemo.libding.entity.news.T1348647909107;
import com.xdw.retrofitrxmvpdemo.libding.rerxmvp.view.activity.NewsDetailActivity;
import com.xdw.retrofitrxmvpdemo.libding.util.Utils;
import com.xdw.retrofitrxmvpdemo.libding.weigit.view.ADPager;
import com.xdw.retrofitrxmvpdemo.libding.weigit.view.MultiImageView;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position, boolean isItem) {
        ...
        if (getItemViewType(position) == TYPE_HEAD) {
            ...
            switch (holder.viewType) {
                case TYPE_NULL_ONE_IMAGE:
                    if (item.getImgsrc() != null) {
                        Glide.with(PadApplication.getContext()).load(item.getImgsrc()).asBitmap().
